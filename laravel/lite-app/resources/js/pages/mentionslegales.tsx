        ...
        <>
            ...
            <div className="h-full w-1/2 flex flex-col">
                ...
                <p>
                    ...
                    graphismes, interfaces, logos, icônes, sons, logiciels et
                    bases de données, est protégé par les dispositions du Code
                    de la propriété intellectuelle. Toute reproduction,
                    représentation, modification, publication ou adaptation de
                    tout ou partie du site, quel que soit le moyen ou le procédé
                ...
                <p>
                    ...
                    (RGPD) et de la loi « Informatique et Libertés ». Les
                    données collectées sont nécessaires :
                </p>
                <ul>
                    <li>
                        à la création et à la gestion des comptes utilisateurs,
                    </li>
                ...
                <p>
                    ...
                    concernant leurs données personnelles. Toute demande peut
                    être adressée à : <br />
                    📧 in.the.end22300@gmail.com
                </p>
                <h2>Cookies</h2>
                <p>
                    Le site Lite utilise des cookies et traceurs afin d’assurer
                    son bon fonctionnement, mesurer l’audience et améliorer
                    l’expérience utilisateur. L’utilisateur peut configurer ou
                    refuser les cookies via les paramètres de son navigateur ou
                    le bandeau de gestion des cookies prévu à cet effet.
                </p>
                <h2>Responsabilité</h2>
                <p>
                    Muse s’efforce de fournir des informations aussi précises
                    que possible sur le site Lite. <br/>
